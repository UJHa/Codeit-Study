...
def solution(answers):
    ...
    person_1 = [1,2,3,4,5] * (int(len(answers)//len([1,2,3,4,5]))+1)
    person_2 = [2, 1, 2, 3, 2, 4, 2, 5] * (int(len(answers)//len([2, 1, 2, 3, 2, 4, 2, 5]))+1)
    person_3 = [3, 3, 1, 1, 2, 2, 4, 4, 5, 5] * (int(len(answers)//len([3, 3, 1, 1, 2, 2, 4, 4, 5, 5]))+1)
